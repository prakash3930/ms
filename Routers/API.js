...
// reply section==============================================
router.post('/createCommentReply',tokenVerify,fileUpload, commentReplyCreate);
router.get('/getCommentReply/:id',tokenVerify, getCommentReply);
router.put('/updateCommentReply/:id',tokenVerify,fileUpload, updateCommentReply);
